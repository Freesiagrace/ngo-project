...
<nav class="bg-gray-900 text-white py-4">
    <div class="container mx-auto flex justify-between items-center">
        <a class="text-2xl font-bold" href="<?php echo e(url('/')); ?>">NGO</a>
        <div class="hidden md:flex space-x-10 ml-16">
            <a href="<?php echo e(url('/')); ?>" class="hover:text-gray-400">Home</a>
            <a href="<?php echo e(route('about')); ?>" class="hover:text-gray-400">About Us</a>
            <a href="#" class="hover:text-gray-400">Contact</a>
            <a href="#" class="hover:text-gray-400">Blogs</a>
        </div>
        <div class="flex space-x-4">
            <a href="<?php echo e(route('donate')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded h-9 w-24 text-center">Donate</a>
            <a href="<?php echo e(route('sponsor')); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white font-medium px-4 py-2 rounded h-9 w-24 text-center">Sponsor</a>
        </div>
    </div>
</nav>
...
<?php /**PATH C:\xampp\htdocs\NgoProject\resources\views/layouts/app.blade.php ENDPATH**/ ?>